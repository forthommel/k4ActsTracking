#ifndef k4ActsTracking_GeometryContainers_h
#define k4ActsTracking_GeometryContainers_h
...
namespace k4ActsTracking {
  ...
  template <typename T> struct GeometryIdMultisetAccessor {
    ...
    const Container* container{nullptr};  ///< Pointer to the container
    ...
    /// Range of elements with requested geoId
